...
\begin{figure}
	...
	\caption{\textsc{Effect of Unemployment Benefits on Non-Employment Duration and Wage Change}}
...
\begin{figure}
	...
	\includegraphics[width=\textwidth]{../../out/figures/data_analysis/treatment_effect_estimates_ned.png}
	\caption{Non-employment duration}
	\label{fig: bw_perf_ned}
	\end{subfigure}
	\begin{subfigure}{0.49\linewidth}
	\includegraphics[width=\textwidth]{../../out/figures/data_analysis/treatment_effect_estimates_wg_c.png}
	\caption{Wage change}
	\label{fig: bw_perf_wg_c}
	\end{subfigure}
